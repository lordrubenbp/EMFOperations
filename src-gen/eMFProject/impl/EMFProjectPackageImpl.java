 ...
 * @generated
 */
public class EMFProjectPackageImpl extends EPackageImpl implements EMFProjectPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see eMFProject.EMFProjectPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private EMFProjectPackageImpl() {
		super(eNS_URI, EMFProjectFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link EMFProjectPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static EMFProjectPackage init() {
		if (isInited)
			return (EMFProjectPackage) EPackage.Registry.INSTANCE.getEPackage(EMFProjectPackage.eNS_URI);

		// Obtain or create and register package
		EMFProjectPackageImpl theEMFProjectPackage = (EMFProjectPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof EMFProjectPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
						: new EMFProjectPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theEMFProjectPackage.createPackageContents();

		// Initialize created meta-data
		theEMFProjectPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theEMFProjectPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(EMFProjectPackage.eNS_URI, theEMFProjectPackage);
		return theEMFProjectPackage;
	}
	 ...
	 * @generated
	 */
	public EMFProjectFactory getEMFProjectFactory() {
		return (EMFProjectFactory) getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getEvent_Code(), ecorePackage.getEString(), "code", null, 0, 1, Event.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(commandEClass, Command.class, "Command", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCommand_Name(), ecorePackage.getEString(), "name", null, 0, 1, Command.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCommand_Code(), ecorePackage.getEString(), "code", null, 0, 1, Command.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
